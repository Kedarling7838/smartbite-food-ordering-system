...
class MyOrdersListSerializer(serializers.ModelSerializer):
    ...
    def get_order_final_status(self,obj):
        return obj.order_final_status or "Wating for Restauraant confirmation"
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model=User
        fields=['id','first_name','last_name','email','reg_date']
...
class OrderDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=OrderAddress
        fields=['order_number','order_time','order_final_status','address','user_first_name','user_last_name','user_email']
