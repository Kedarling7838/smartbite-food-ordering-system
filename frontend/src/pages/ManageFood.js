        ...
        <AdminLayout>
            ...
            <div>
                ...
                <div className="mb-3 d-flex justify-content-between">
                    <input type="text" className="form-control w-50" placeholder="Search by item name...!" onChange={(e)=>handelSearch(e.target.value)}></input>
                    ...
                    <tbody>
                        ...
                        <tr key={food.id}>
                            ...
                            <td>
                                ...
                                <button onClick={()=>handelDelete(food.id)} className="btn btn-sm btn-danger">
