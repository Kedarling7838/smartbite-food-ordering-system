                ...
                <form onSubmit={handelSubmit} className="mb-4">
                    <div className="row mb-3">
                        <div className="col-md-4">
                            <label className="mb-2">Form Date</label>
                            <input type="date" name="from_date" onChange={handelChange} className="form-control" required/>
                        </div>

                        <div className="col-md-4">
                            <label className="mb-2">To Date</label>
                            <input type="date" name="to_date" onChange={handelChange} className="form-control" required/>
                        </div>

                        <div className="col-md-4">
                            <label className="mb-2">Status</label>
                            <select type="date" name="status" onChange={handelChange} className="form-control">
