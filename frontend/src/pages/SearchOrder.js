...
const SearchOrder=()=>{
    ...
    return(
         <AdminLayout>
            ...
            <form onSubmit={handelSearch} className="d-flex mt-3" style={{maxWidth:'600px',margin:'0 auto'}}>
                    <input type="text" onChange={(e)=>setSearchTerm(e.target.value)} placeholder="Enter Order Number..." className="form-control" 
