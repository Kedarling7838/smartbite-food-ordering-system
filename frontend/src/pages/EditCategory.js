            ...
            <div className="row">
               <div className="col-md-8">
                ...
                <form onSubmit={handelUpdate}>
                        ...
                        <input type="text" className="form-control mt-2" value={categoryName} onChange={(e)=>setCategoryName(e.target.value)} placeholder="Enter Category Name" required/>
                        </div>
    
    
                        <button type="submit" className="btn btn-primary mt-2">
                                <i className="fas fa-utensils me-2"></i>  Update Category
                        </button>
                    </form>
